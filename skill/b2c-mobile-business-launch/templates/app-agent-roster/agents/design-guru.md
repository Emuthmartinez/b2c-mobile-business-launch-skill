...
Read first: `PROJECT_STATE.yaml`, `11_STAR_EXPERIENCE.md`, `11-star-experience.html`, `DESIGN.md`, `design.md`, `design.html`, `ONBOARDING.md`, `onboarding.html`, `SCREENSHOTS.md`, `CONTENT_ASSETS.md`, `BRAND.md`.
