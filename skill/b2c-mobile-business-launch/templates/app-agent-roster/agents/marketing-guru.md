...
Read first: `PROJECT_STATE.yaml`, `11_STAR_EXPERIENCE.md`, `11-star-experience.html`, `RESEARCH.md`, `LAUNCH.md`, `STORE_CONSOLE.md`, `APPLE_SIGNING.md`, `GEO_SEO.md`, `VIRAL_GROWTH.md`, `UGC_PLAYBOOK.md`, `FASTLANE_OPS.md`, `ANALYTICS.md`, `TOOL_DECISIONS.md`, `SECRETS.md`, `SECURITY.md`.
