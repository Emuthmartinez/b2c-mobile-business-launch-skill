...
8. **Ship app-local agent roles.** Use [`references/app-agent-roster.md`](references/app-agent-roster.md) and [`templates/app-agent-roster/`](templates/app-agent-roster/) before creating app handoffs, builder-ready bundles, `AGENTS.md`, `CLAUDE.md`, or post-launch operating docs. Real app builds should include `APP_AGENTS.md` and six simple role prompts under `agents/`: orchestrator, marketing, engineering, product, design, and customer success.
...
- Load [`references/xcodebuildmcp-testing.md`](references/xcodebuildmcp-testing.md) when MobAI is unavailable and the founder confirms an Apple-platform free/open-source testing fallback, or when XcodeBuildMCP install/setup/client/CLI/config/tool/privacy/skills guidance is needed.
